#' lsmnsd: A package for classifying animal movement strategies based on latent-space model and net squared displacement.
#'
...
#'
#' A dataset containing the x, y locations (UTM), and time of Christian, a male giant tortoises inhabiting Alcedo volcano on Isabela Island, Galapagos. 
#'
...
#'
#' A dataset containing the x, y locations (UTM), and time of Zelfa, a female giant tortoises inhabiting Espanola Island, Galapagos. 
#'
